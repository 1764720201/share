	...
	<view class="dSLComVue">
		...
		<view v-if="is_show_more" class="dSLComVue">
			<view class="dSLComVueTitle">
				<text>搜索历史</text>
				<view
					style="width: 100rpx;height: 60rpx;display: flex;align-items: center;justify-content: flex-end;margin-left: -50rpx;"
					@click="onClickDelAll"
				>
			...
			>
				<text>热门搜索</text>
				<view @click="onClickShowHot">
					<uni-icons :type="is_hot_show ? 'eye' : 'eye-slash'" />
				</view>
			</view>
